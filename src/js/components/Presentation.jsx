    ...
    <>
        ...
        <div className='flex flex-col items-center justify-center mx-auto md:-ml-[2rem] mt-[13rem] lg:-ml-[10rem] w-full '>
          <div className='space-y-8 z-10 text-center md:text-left'>
              ...
              <h2 className='text-[#4CCD99] text-3xl md:text-5xl h-[55px] w-[] animate-typing overflow-hidden whitespace-nowrap border-r-4 border-r-white'>A {words[currentIndex]}</h2>
              <p className='text-white max-w-[450px] md:max-w-[650px]'>
