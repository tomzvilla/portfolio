...
const Footer = () => {
  return (
    <div className='flex flex-col text-white items-center justify-center'>
        <Link to={'/#start'}>
            <h1 className='text-xl mb-10 hover:text-primary'>Tomas Villarreal</h1>
        </Link>
        <div className='flex flex-row gap-10 mb-10'>
            <a href="mailto:villarrealtomas@hotmail.com">
                <svg className='fill-current w-[26px] h-[26px] text-white hover:text-primary' xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
            ...
            <a href="https://www.linkedin.com/in/villarreal-tomas/" target='_blank'>
                <svg className='fill-current w-[22px] h-[22px] text-white hover:text-primary' xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 16 16">
        ...
        <small className='mb-5 text-center'> © 2024 Designed and Built with ❤ by Tomas Villarreal</small>
